...
Perfect fallback solution for environments that are only supposed to host source files, not compiled one (like [GitHub Pages](https://help.github.com/en/github/working-with-github-pages/about-github-pages)).
